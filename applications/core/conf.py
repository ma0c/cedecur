...
ENTERPRISE_SUMMARY_COUNTER_URL_NAME = ENTERPRISE_PREFIX + "_summary_counter"
...
DISCOUNTS_VALIDATE_CODE_URL_NAME = DISCOUNTS_PREFIX + "_validate_qr"
DISCOUNT_DOES_NOT_EXISTS = _("Discount does not exists")
DISCOUNT_VALID = _("Discount valid")
DISCOUNT_EXPIRED = _("Discount expired")
...
MESSAGE_POSTED_UNSUCCESSFULLY = _("Message were not posted, please fill all the fields")
